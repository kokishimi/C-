...
double calc_S(double Lat) {
	double xS;
	//	xS = B1*Lat - B2*sin(2*Lat) + B3*sin(4*Lat) - B4*sin(6*Lat) + B5*sin(8*Lat) - B6*sin(10*Lat);

	xS = B1 * Lat + B2 * sin(2.0*Lat) + B3 * sin(4.0*Lat) + B4 * sin(6.0*Lat) + B5 * sin(8.0*Lat) + B6 * sin(10.0*Lat) + B7 * sin(12.0*Lat) + B8 * sin(14.0*Lat) + B9 * sin(16.0*Lat);
	return xS;
}
/********************************************************************/
/* εの計算
